...
void intro(GameState *currentState, Visuals space, int *score)
{
	BeginDrawing();
		...
		DrawText(TextFormat("Score: %d", *score), SCREEN_WIDTH / 2 - text1Width / 2, 1750, 100, WHITE);
		DrawText("W, S, A, D to move. Arrows to change bullets' direction.", SCREEN_WIDTH / 2 - text2Width / 2, 1950, 50, ORANGE);
		DrawText("Press SPACE to start!", SCREEN_WIDTH / 2 - text3Width / 2, 2050, 50, ORANGE);
